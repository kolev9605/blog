  ...
  <BaseCard title="Home">
    <div class="flex">
      <div class="p-6">
          ...
          This is my blog where I poast about random topics I am passionate about.
      </div>
    </div>
    ...
    <div class="flex">
      <div class="p-6">
          ...
          My name is Georgi Kolev and I've been a software developer for about 8 years now primarily using the .NET ecosystem.
      </div>
    </div>
